...
<section>
    ...
    <div class="person-info">
        ...
        <?php if($page->lectures()->isNotEmpty()): ?>
            <?php $lectures = $page->lectures()->toStructure(); ?>
            <h2 class="person-subhead">Lectures & Talks</h2>
            <ul id="lecturelist">
                <?php foreach($lectures as $lecture): ?>
                    <li><span class="bullet" aria-hidden="true">
...
</span><a href="<?= $lecture->talklink() ?>" class="external-link lecturelink"><?= $lecture->talktitle() ?></a>
                <?php endforeach ?>
            </ul>
        <?php endif ?>
    </div>
